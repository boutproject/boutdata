...
def test_spectrogram(n, d, s):
    ...
    plt.xlabel(r"$t$")
    plt.title(rf"Spectrogram of $sin(t + cos(t) )$ with $\sigma=${s1:3.1f}")
    ...
    plt.ylabel("frequency")
    plt.xlabel(r"$t$")
    plt.title(rf"Spectrogram of $sin(t + cos(t) )$ with $\sigma=${s2:3.1f}")
    ...
    plt.ylabel("frequency")
    plt.xlabel(r"$t$")
    plt.title(rf"Spectrogram of $sin(t + cos(t) )$ with $\sigma=${s3:3.1f}")
    plt.tight_layout()
    plt.show()
